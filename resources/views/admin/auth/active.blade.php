...
<head>
    ...
    <title>{{ config('app.name') }} | Activation </title>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="ibox-content">
                    <p>가입하신 이메일로 사용자 인증을 위하여 이메일을 발송합니다. 가입하신 이메일 주소를 넣어주세요.</p>
                    <form id="form-login" class="m-t" role="form" action="{{ url('user/activation/send') }}" method="POST">
                        {{ csrf_field() }}
